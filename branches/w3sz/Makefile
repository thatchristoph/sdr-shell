...
# Generated by qmake (1.07a) (Qt 3.3.8b) on: Mon Mar 16 00:50:55 2009
...
LINK     = g++
LFLAGS   = 
LIBS     = $(SUBLIBS) -L/usr/share/qt3/lib -L/usr/X11R6/lib `pkg-config --cflags --libs hamlib` -lqt-mt -lXext -lX11 -lm -lpthread
AR       = ar cqs
RANLIB   = 
