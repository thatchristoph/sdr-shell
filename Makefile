...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Wed Dec 1 21:59:01 2010
...
SOURCES       = main.cpp \
		...
		pbscale.cpp \
		dttsp.cpp \
		lcdfreq.cpp moc_main_widget.cpp \
		moc_spectrogram.cpp \
		moc_varilabel.cpp \
		moc_memorycell.cpp \
		moc_pbscale.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sdr-shell1.0.0/ && $(COPY_FILE) --parents main_widget.h spectrogram.h varilabel.h memorycell.h pbscale.h spectrum.h text.h hamlibwrapper.h dttsp.h lcdfreq.h .tmp/sdr-shell1.0.0/ && $(COPY_FILE) --parents main.cpp main_widget.cpp spectrogram.cpp varilabel.cpp memorycell.cpp spectrum.cpp hamlibwrapper.cpp pbscale.cpp dttsp.cpp lcdfreq.cpp .tmp/sdr-shell1.0.0/ && (cd `dirname .tmp/sdr-shell1.0.0` && $(TAR) sdr-shell1.0.0.tar sdr-shell1.0.0 && $(COMPRESS) sdr-shell1.0.0.tar) && $(MOVE) `dirname .tmp/sdr-shell1.0.0`/sdr-shell1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sdr-shell1.0.0
...
compiler_moc_header_make_all: moc_main_widget.cpp moc_spectrogram.cpp moc_varilabel.cpp moc_memorycell.cpp moc_pbscale.cpp moc_spectrum.cpp moc_hamlibwrapper.cpp moc_lcdfreq.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main_widget.cpp moc_spectrogram.cpp moc_varilabel.cpp moc_memorycell.cpp moc_pbscale.cpp moc_spectrum.cpp moc_hamlibwrapper.cpp moc_lcdfreq.cpp
